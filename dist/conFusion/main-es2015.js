...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_services_dish_service__WEBPACK_IMPORTED_MODULE_14__["DishService"], _services_promotion_service__WEBPACK_IMPORTED_MODULE_20__["PromotionService"]], imports: [[
...
class HomeComponent {
    constructor(dishservice, promotionservice) {
...
HomeComponent.ɵfac = function HomeComponent_Factory(t) { return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_dish_service__WEBPACK_IMPORTED_MODULE_1__["DishService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_promotion_service__WEBPACK_IMPORTED_MODULE_2__["PromotionService"])); };
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 3, vars: 2, consts: [["fxLayout", "row", "fxLayout.sm", "column", "fxLayout.xs", "column", "fxLayoutAlign.gt-md", "space-around center", "fxLayoutGap", "10px", 1, "container"], ["fxFlex", "", 4, "ngIf"], ["fxFlex", ""], ["mat-card-avatar", ""], ["mat-card-image", "", 3, "src", "alt"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
    ...
    }], function () { return [{ type: _services_dish_service__WEBPACK_IMPORTED_MODULE_1__["DishService"] }, { type: _services_promotion_service__WEBPACK_IMPORTED_MODULE_2__["PromotionService"] }]; }, null); })();
...
class DishService {
    ...
    getDish(id) {
        return _shared_dishers__WEBPACK_IMPORTED_MODULE_1__["DISHEs"].filter((dish) => (dish.id === id))[0];
    }
    getFeaturedDish() {
        return _shared_dishers__WEBPACK_IMPORTED_MODULE_1__["DISHEs"].filter((dish) => dish.featured)[0];
    }
}
...
class PromotionService {
    ...
    getPromotion(id) {
        return _shared_promotions__WEBPACK_IMPORTED_MODULE_1__["PROMOTIONS"].filter((promo) => (promo.id === id))[0];
    }
    getFeaturedPromotion() {
        return _shared_promotions__WEBPACK_IMPORTED_MODULE_1__["PROMOTIONS"].filter((promotion) => promotion.featured)[0];
    }
}
PromotionService.ɵfac = function PromotionService_Factory(t) { return new (t || PromotionService)(); };
